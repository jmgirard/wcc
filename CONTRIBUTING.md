# Contributing to bsync

This outlines how to propose a change to bsync. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("jmgirard/bsync", fork = TRUE)`.
...
Please note that the bsync project is released with a [Contributor Code
of Conduct](https://jmgirard.github.io/bsync/CODE_OF_CONDUCT.md). By
