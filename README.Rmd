...
Once the cross-correlations are calculated, we extract the specific lags that represent the optimal association within each time window. Printing the optima object displays the extraction metadata alongside the first few results.
