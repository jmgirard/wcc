...
Thanks for using bsync! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/jmgirard/bsync/issues/new).
...
requests](https://github.com/jmgirard/bsync/issues) to make sure the bug
